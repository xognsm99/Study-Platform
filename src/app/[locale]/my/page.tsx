    ...
    return (
      <div className="px-4 pt-4 pb-24 max-[380px]:px-3 max-[380px]:pt-3">
        <div className="mx-auto w-full max-w-md">
          <div className="rounded-2xl bg-white p-6 pt-7 pb-7 shadow-[0_2px_8px_rgba(0,0,0,0.06)] max-[380px]:p-5">
  ...
  return (
    <div className="px-4 pt-4 pb-24 max-[380px]:px-3 max-[380px]:pt-3">
      <div className="mx-auto w-full max-w-md">
        ...
        {showForm && (
          <div className="rounded-2xl bg-white p-6 pt-7 pb-7 shadow-[0_2px_8px_rgba(0,0,0,0.06)] max-[380px]:p-5">
            <div className="text-lg font-semibold text-gray-900 mb-4">프로필 설정</div>
